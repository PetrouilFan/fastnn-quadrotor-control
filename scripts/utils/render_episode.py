...
def create_stage11p(args):
    ...
    from fastnn_quadrotor.quadrotor.env_stage11_primitive_v3 import QuadrotorEnvStage11PrimitiveV3
...
def create_stage12comb(args):
    ...
    from fastnn_quadrotor.quadrotor.env_stage12_combined import QuadrotorEnvStage12Combined
    from fastnn_quadrotor.quadrotor.env_stage11_trajectory import QuadrotorEnvStage11Trajectory
...
def create_stage13s(args):
    ...
    from fastnn_quadrotor.quadrotor.env_stage13_shielded import QuadrotorEnvStage13Shielded
    from fastnn_quadrotor.quadrotor.env_stage11_trajectory import QuadrotorEnvStage11Trajectory
...
def create_stage13b(args):
    ...
    from fastnn_quadrotor.quadrotor.env_stage13_bodyframe import QuadrotorEnvStage13Bodyframe
    from fastnn_quadrotor.quadrotor.env_stage11_trajectory import QuadrotorEnvStage11Trajectory
...
def create_stage14s(args):
    ...
    from fastnn_quadrotor.quadrotor.env_stage14_smoothed import QuadrotorEnvStage14Smoothed
    from fastnn_quadrotor.quadrotor.env_stage11_trajectory import QuadrotorEnvStage11Trajectory
